...
export const PermissionCode = {
  ...
  // ATTRIBUTE_FAMILIES (ierarxik atribut oilasi)
  ATTRIBUTE_FAMILIES_VIEW: 'ATTRIBUTE_FAMILIES_VIEW',
  ATTRIBUTE_FAMILIES_CREATE: 'ATTRIBUTE_FAMILIES_CREATE',
  ATTRIBUTE_FAMILIES_UPDATE: 'ATTRIBUTE_FAMILIES_UPDATE',
  ATTRIBUTE_FAMILIES_DELETE: 'ATTRIBUTE_FAMILIES_DELETE',
  ...
  PAYMENT_SCHEDULE_MANAGE: 'PAYMENT_SCHEDULE_MANAGE',

  // WARRANTY
  WARRANTY_VIEW: 'WARRANTY_VIEW',
  WARRANTY_CREATE: 'WARRANTY_CREATE',
  WARRANTY_MANAGE: 'WARRANTY_MANAGE',
  WARRANTY_RESOLVE: 'WARRANTY_RESOLVE',
} as const;
