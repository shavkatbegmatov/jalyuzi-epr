    ...
    <div className="space-y-6">
      ...
      <div className="card bg-base-100 shadow-sm">
        <div className="card-body items-center text-center">
          <div className="w-20 h-20 rounded-full bg-gradient-to-br from-warning/20 to-secondary/20 flex items-center justify-center ring-4 ring-warning/10">
            <span className="text-3xl font-bold text-warning">{userInitial}</span>
          </div>
      ...
      <div className="card bg-base-100 shadow-sm">
        <div className="card-body">
          ...
          <form onSubmit={handleSubmit(onSubmitPassword)} className="space-y-3">
            ...
            <button type="submit" className="btn btn-warning btn-sm w-full" disabled={changingPassword}>
              {changingPassword ? (
                <>
