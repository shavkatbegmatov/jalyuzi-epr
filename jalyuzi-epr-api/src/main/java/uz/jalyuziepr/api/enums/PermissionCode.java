...
public enum PermissionCode {
    ...
    // INSTALLERS module
    INSTALLERS_VIEW("INSTALLERS", "VIEW"),
    INSTALLERS_CREATE("INSTALLERS", "CREATE"),
    INSTALLERS_UPDATE("INSTALLERS", "UPDATE"),
    INSTALLERS_TOGGLE("INSTALLERS", "TOGGLE"),
    ...
    // PAYMENT_SCHEDULE module
    PAYMENT_SCHEDULE_VIEW("PAYMENT_SCHEDULE", "VIEW"),
    PAYMENT_SCHEDULE_MANAGE("PAYMENT_SCHEDULE", "MANAGE"),
